...
public final class CollectionArgs extends com.pulumi.resources.ResourceArgs {
    ...
    /**
     * @return The URL-friendly slug for the collection (optional, e.g., &#39;blog-posts&#39;, &#39;products&#39;). If not provided, Webflow will auto-generate a slug from the displayName and the generated value is recorded in the resource outputs without causing a diff. The slug determines the URL path for collection items; changing an explicit slug updates the collection in place, which changes the URLs of its items.
     * 
     */
    ...
    public static final class Builder {
        ...
        /**
         * @param slug The URL-friendly slug for the collection (optional, e.g., &#39;blog-posts&#39;, &#39;products&#39;). If not provided, Webflow will auto-generate a slug from the displayName and the generated value is recorded in the resource outputs without causing a diff. The slug determines the URL path for collection items; changing an explicit slug updates the collection in place, which changes the URLs of its items.
         * 
         * @return builder
         * 
         */
