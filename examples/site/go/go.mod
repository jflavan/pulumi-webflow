...
require (
	github.com/JDetmar/pulumi-webflow/sdk/go/webflow v0.10.1
...
// the publishToWebflowSubdomain/publishCustomDomains/publishPageId inputs are newer than the published v0.10.1 module, so this example
// builds against the SDK in this repository. Drop the directive once the next release is published.
